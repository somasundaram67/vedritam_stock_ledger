...
const App = (function() {
    ...
    const users = {
        ...
        openEdit(username) {
            ...
            const canSetPwd = isSuperAdmin() || u.role === 'user' || u.username === state.username;
            ['editUserPassword', 'editUserPassword2'].forEach(id => {
        ...
        async init() {
            ...
            if (!isSuperAdmin() && !isStaff()) {
                document.getElementById('auditBody').innerHTML =
                    '<tr><td colspan="5" style="padding:20px;text-align:center;">Staff or Super Admin access required.</td></tr>';
                return;
            }
            await this.load();
