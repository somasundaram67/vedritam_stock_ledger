/* Floating chatbot: answers from the Stock Ledger data in scope. */
(function () {
    ...
    const headTitle = () => '🤖 Ledger Assistant';
    const placeholder = () => 'Ask about stock, books, schools...';
    ...
    const history = [];
    add('cbSys', 'Hi! Ask me anything — I can answer general questions and, when relevant, use your Stock Ledger data.');
